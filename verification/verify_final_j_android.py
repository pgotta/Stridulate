...
for token in ['applicationId = "com.pgotta.stridulate"','versionCode = 16','versionName = "0.3"','onnxruntime-android:1.26.0','noCompress += "onnx"','prepareJ1Runtime','stridulate.bundleJ1Runtime','tphakala/Perch-v2']:

...
CALIBRATION_SHA='9a8323d4f6aea3bd85d36d55eadbc38d6eb85088451bee9682a46216ee79c70f'
CALIBRATION_BYTES=69561
...
for token in [
    PERCH_SHA, str(PERCH_BYTES), 'models/perch_v2_no_dft.onnx',
    'models/j1_stage_d_affine.bin', '066c6cf64b165abb83af93e4b1a38a4a3ffce2fa9ec476a5b3b9695466a6d76a',
    'models/j1_calibration.json', CALIBRATION_SHA, 'CALIBRATION_BYTES = 69561L',
    'STAGE_D_TEMPERATURE = 4.0', 'root.getJSONObject("session_policy")',
...
print(f'labels={len(labels)} affine=541040 bytes calibration={CALIBRATION_BYTES} bytes perch={PERCH_BYTES} bytes (external staged runtime)')
